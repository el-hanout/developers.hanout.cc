import{H as a}from"./Header-U8JmSnk9.js";import"./jsx-runtime-NB1XKu45.js";import"./iframe-BmJKktP_.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-CyWcMwez.js";import"./arrow-up-Ch9widLQ.js";import"./createLucideIcon-BBgPBf4j.js";const{fn:r}=__STORYBOOK_MODULE_TEST__,u={title:"Example/Header",component:a,tags:["autodocs"],parameters:{layout:"fullscreen"},args:{onLogin:r(),onLogout:r(),onCreateAccount:r()}},e={args:{user:{name:"Jane Doe"}}},o={};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{code:`const LoggedIn = () => <Header
    onLogin={fn()}
    onLogout={fn()}
    onCreateAccount={fn()}
    user={{
