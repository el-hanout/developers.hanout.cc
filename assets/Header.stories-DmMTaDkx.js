import{H as a}from"./Header-DwCnyEfN.js";import"./jsx-runtime-Dncq-JsW.js";import"./iframe-PrwFdjD9.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-DJYCTFZr.js";import"./createLucideIcon-BPNEDEPx.js";import"./arrow-up-BmI_yg9i.js";const{fn:r}=__STORYBOOK_MODULE_TEST__,u={title:"Example/Header",component:a,tags:["autodocs"],parameters:{layout:"fullscreen"},args:{onLogin:r(),onLogout:r(),onCreateAccount:r()}},e={args:{user:{name:"Jane Doe"}}},o={};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{code:`const LoggedIn = () => <Header
    onLogin={fn()}
    onLogout={fn()}
    onCreateAccount={fn()}
    user={{
