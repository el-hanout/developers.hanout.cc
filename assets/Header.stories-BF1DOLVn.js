import{H as a}from"./Header-Be73OJps.js";import"./jsx-runtime-BGHlHzo0.js";import"./iframe-DEci3Ye8.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-CtnWqazD.js";import"./createLucideIcon-CcHW9wpt.js";import"./arrow-up-d1sOlVjY.js";const{fn:r}=__STORYBOOK_MODULE_TEST__,u={title:"Example/Header",component:a,tags:["autodocs"],parameters:{layout:"fullscreen"},args:{onLogin:r(),onLogout:r(),onCreateAccount:r()}},e={args:{user:{name:"Jane Doe"}}},o={};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{code:`const LoggedIn = () => <Header
    onLogin={fn()}
    onLogout={fn()}
    onCreateAccount={fn()}
    user={{
