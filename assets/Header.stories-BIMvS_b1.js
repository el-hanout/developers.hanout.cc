import{H as a}from"./Header-BspbWe30.js";import"./jsx-runtime-C7JLgHXN.js";import"./iframe-Cj8hrqrB.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-C3UA1BRf.js";import"./createLucideIcon-DVHixRSd.js";import"./arrow-up-6MZNaLMn.js";const{fn:r}=__STORYBOOK_MODULE_TEST__,u={title:"Example/Header",component:a,tags:["autodocs"],parameters:{layout:"fullscreen"},args:{onLogin:r(),onLogout:r(),onCreateAccount:r()}},e={args:{user:{name:"Jane Doe"}}},o={};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{code:`const LoggedIn = () => <Header
    onLogin={fn()}
    onLogout={fn()}
    onCreateAccount={fn()}
    user={{
