import{H as a}from"./Header-Co1M6cmO.js";import"./jsx-runtime-k7loakwk.js";import"./iframe-Cj5yWX7k.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-Dzbh0dh7.js";import"./createLucideIcon-BUbIFGIJ.js";import"./arrow-up-DQzps-II.js";const{fn:r}=__STORYBOOK_MODULE_TEST__,u={title:"Example/Header",component:a,tags:["autodocs"],parameters:{layout:"fullscreen"},args:{onLogin:r(),onLogout:r(),onCreateAccount:r()}},e={args:{user:{name:"Jane Doe"}}},o={};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{code:`const LoggedIn = () => <Header
    onLogin={fn()}
    onLogout={fn()}
    onCreateAccount={fn()}
    user={{
