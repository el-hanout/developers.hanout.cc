import{H as a}from"./Header-S47BVaGi.js";import"./jsx-runtime-CChQA9tb.js";import"./iframe-D5OrQ5bS.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-tOU_Dkiy.js";import"./createLucideIcon-CP_7qT0j.js";import"./arrow-up-CBUurEKt.js";const{fn:r}=__STORYBOOK_MODULE_TEST__,u={title:"Example/Header",component:a,tags:["autodocs"],parameters:{layout:"fullscreen"},args:{onLogin:r(),onLogout:r(),onCreateAccount:r()}},e={args:{user:{name:"Jane Doe"}}},o={};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{code:`const LoggedIn = () => <Header
    onLogin={fn()}
    onLogout={fn()}
    onCreateAccount={fn()}
    user={{
